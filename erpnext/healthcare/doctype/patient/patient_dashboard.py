	...
	return {
		...
		'transactions': [
			...
			},
			{
				...
				'items': ['Clinical History Psychology', 'Medical Evolution Notes Psychology', 'Psychology Test Sheet', 'Reference and Response', 'Scanned Contracts Psychology']
			},
			{
				'label': _('Historial Psiquiatria'),
				'items': ['Psychiatric Clinical History', 'Medical Evolution Notes Psychiatry', 'Psychiatry Examination Sheet', 'Reference and Answers Psychiatry', 'Clinical Deposit Registration']
			},
			{
